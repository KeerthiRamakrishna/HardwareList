...
{
    public partial class AddAutosarVersion
    {
        [Inject]
        ...
        {
            autosarVersion = new HardwareManagement.Server.Models.FocusDB.AutosarVersion();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await FocusDBService.CreateAutosarVersion(autosarVersion);
