...
{
    public partial class AddTresosAutoCore
    {
        [Inject]
        ...
        {
            tresosAutoCore = new HardwareManagement.Server.Models.FocusDB.TresosAutoCore();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await FocusDBService.CreateTresosAutoCore(tresosAutoCore);
