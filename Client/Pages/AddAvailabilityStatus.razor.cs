...
{
    public partial class AddAvailabilityStatus
    {
        [Inject]
        ...
        {
            availabilityStatus = new HardwareManagement.Server.Models.FocusDB.AvailabilityStatus();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await FocusDBService.CreateAvailabilityStatus(availabilityStatus);
