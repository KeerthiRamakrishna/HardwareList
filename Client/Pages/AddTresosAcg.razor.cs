...
{
    public partial class AddTresosAcg
    {
        [Inject]
        ...
        {
            tresosAcg = new HardwareManagement.Server.Models.FocusDB.TresosAcg();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await FocusDBService.CreateTresosAcg(tresosAcg);
