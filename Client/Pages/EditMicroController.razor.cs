...
{
    public partial class EditMicroController
    {
        [Inject]
        ...
        {
            microController = await FocusDBService.GetMicroControllerByHardwareId(hardwareId:HardwareId);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await FocusDBService.UpdateMicroController(hardwareId:HardwareId, microController);
