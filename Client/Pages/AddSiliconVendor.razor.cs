...
{
    public partial class AddSiliconVendor
    {
        [Inject]
        ...
        {
            siliconVendor = new HardwareManagement.Server.Models.FocusDB.SiliconVendor();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await FocusDBService.CreateSiliconVendor(siliconVendor);
