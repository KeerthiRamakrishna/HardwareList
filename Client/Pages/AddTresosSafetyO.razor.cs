...
{
    public partial class AddTresosSafetyO
    {
        [Inject]
        ...
        {
            tresosSafetyO = new HardwareManagement.Server.Models.FocusDB.TresosSafetyO();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await FocusDBService.CreateTresosSafetyO(tresosSafetyO);
