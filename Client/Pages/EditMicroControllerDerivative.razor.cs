...
{
    public partial class EditMicroControllerDerivative
    {
        [Inject]
        ...
        {
            microControllerDerivative = await FocusDBService.GetMicroControllerDerivativeByMicroControllerDerivativesId(microControllerDerivativesId:MicroControllerDerivativesID);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await FocusDBService.UpdateMicroControllerDerivative(microControllerDerivativesId:MicroControllerDerivativesID, microControllerDerivative);
